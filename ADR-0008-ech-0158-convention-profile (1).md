...
- Der konkrete, prüfbare Regelsatz (~50 Regeln) liegt in
  `docs/ech-0158-linter-rules.md`, jeweils mit Regel-ID, betroffenem Element,
  Bedingung, Schweregrad und Prüfart (`mechanic` vs. `heuristic`).
